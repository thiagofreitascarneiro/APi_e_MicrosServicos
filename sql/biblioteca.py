...
def empresta_livro(id_livro, id_aluno):
    with engine.connect() as con:
        sql_create = text ("UPDATE LIVRO SET id_livro=:id_livro WHERE id_livro =:id_livro")
        con.execute(sql_create, id_livro=id_livro, id_launo=id_aluno)
