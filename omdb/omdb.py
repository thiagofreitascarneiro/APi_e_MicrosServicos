...
Digite, por exemplo, a seguinte URL no Firefox:
    http://www.omdbapi.com/?s=star%20wars&apikey=812355b

Observe que vemos uma lista de 10 filmes, mas há mais resultados.

Para ver a página 2, acesse
    http://www.omdbapi.com/?s=star%20wars&page=2&apikey=812355b
...
Na URL http://www.omdbapi.com/?s=star%20wars&page=2&apikey=812355b
...
Como fazer isso? https://www.omdbapi.com/?s=star%20wars&apikey=812355b&type=movie
...
https://www.omdbapi.com/?s=star%20wars&apikey=812355b&page=2&type=game
...
Acessando a URL
http://www.omdbapi.com/?i=tt0076759&apikey=812355b
...
def dicionario_do_filme_por_id(id_filme):
    ...
    pedido = requests.get(url) #conectar na URL
    dicionario_do_pedido = pedido.json() #transformo a string que eu recebi num dicionário de python
    dict = {"ano": dicionario_do_pedido['Year'], 
